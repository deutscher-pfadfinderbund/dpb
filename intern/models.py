...
class House(models.Model):
    ...
    situation = models.CharField('Lage', max_length=1024, blank=True)
    street = models.CharField('Straße', max_length=1024, blank=True)
    plz = models.CharField('PLZ', max_length=1024, blank=True)
    city = models.CharField('Stadt', max_length=1024, blank=True)
    state = models.CharField('Bundesland', max_length=1024, blank=True, null=True)
    accessibility = models.CharField('Erreichbarkeit', max_length=1024, blank=True, null=True)
    ...
    latitude = models.FloatField('Breitengrad', max_length=1024, blank=True, null=True)
    longitude = models.FloatField('Längengrad', max_length=1024, blank=True, null=True)
    display_name = models.CharField('Berechneter Standort', max_length=1024, blank=True, null=True)
    ...
    owner = models.CharField('Name der Gruppe', max_length=1024, blank=True, null=True)
    contact_name = models.CharField('Ansprechpartner', max_length=1024, blank=True)
    contact_tel = models.CharField('Telefon', max_length=1024, blank=True, null=True)
    contact_email = models.EmailField('E-Mail', max_length=1024, blank=True, null=True)
    description = models.TextField('Beschreibung', blank=True, null=True)
    capacity_house = models.CharField('Schlafplätze im Haus', max_length=1024, blank=True, null=True)
    capacity_outdoor = models.CharField('Schlafplätze außerhalb', max_length=1024, blank=True, null=True)
    price_intern = models.CharField('Preise für Pfadfinder', max_length=1024, blank=True, null=True)
    price_extern = models.CharField('Preise für Externe', max_length=1024, blank=True, null=True)
    created = models.DateTimeField('Erstellt am', default=datetime.now)
