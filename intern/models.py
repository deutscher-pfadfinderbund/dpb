...
class House(models.Model):
    ...
    image1 = FilerImageField(related_name="house_image1", blank=True, null=True)
    image2 = FilerImageField(related_name="house_image2", blank=True, null=True)
    image3 = FilerImageField(related_name="house_image3", blank=True, null=True)
