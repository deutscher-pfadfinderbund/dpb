    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_name', models.CharField(null=True, blank=True, verbose_name='Berechneter Standort', max_length=128)),
                ...
                ('capacity_house', models.CharField(null=True, blank=True, verbose_name='Schlafplätze im Haus', max_length=128)),
                ('capacity_outdoor', models.CharField(null=True, blank=True, verbose_name='Schlafplätze außerhalb', max_length=128)),
                ('price_intern', models.CharField(null=True, blank=True, verbose_name='Preise für Pfadfinder', max_length=128)),
                ('price_extern', models.CharField(null=True, blank=True, verbose_name='Preise für Externe', max_length=128)),
                ('image', filer.fields.image.FilerImageField(blank=True, null=True, related_name='house_image', to='filer.Image')),
            ],
            options={
