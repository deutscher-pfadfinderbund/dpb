...
def check_or_cross(check: bool) -> str:
    if check:
        return '<span class="text-success" title="ja">✓<span class="visually-hidden">ja</span></span>'
    return '<span class="text-muted" title="nein">✘<span class="visually-hidden">nein</span></span>'
