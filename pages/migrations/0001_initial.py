    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template_name', models.CharField(max_length=70, blank=True, verbose_name='template name', help_text="Example: 'flatpages/contact_page.html'. If this isn't provided, the system will use 'flatpages/default.html'.")),
